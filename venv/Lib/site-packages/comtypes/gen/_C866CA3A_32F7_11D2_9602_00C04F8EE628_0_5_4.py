...
__all__ = [
    ...
    'SAFT11kHz8BitStereo', 'SVSFNLPSpeakPunc', 'SPEI_RESERVED5',
    'DISPID_SVAlertBoundary', 'SPSNoun', 'DISPID_SFSClose',
    'SPEI_INTERFERENCE', 'DISPID_SLPSymbolic', 'ISpObjectWithToken',
    'SPDKL_LocalMachine', 'SPSERIALIZEDPHRASE',
    'Speech_StreamPos_Asap', 'DISPID_SBSFormat', 'SAFT11kHz16BitMono',
    'DISPID_SRDisplayUI', 'ISpRecognizer', 'SPEI_TTS_PRIVATE',
    'ISpeechObjectTokenCategory', 'SREStateChange',
    'tagSPTEXTSELECTIONINFO', 'SDKLDefaultLocation',
    'SAFT32kHz8BitMono', 'SPRST_INACTIVE_WITH_PURGE', 'SP_VISEME_5',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRules_NewEnum',
    'SRATopLevel', 'SREStreamStart', 'SpObjectTokenCategory',
    'DISPID_SPPChildren', 'DISPID_SGRsCount', 'ISpeechResourceLoader',
    'ISpeechGrammarRuleStateTransitions', 'SPVOICESTATUS',
    'WAVEFORMATEX', 'DISPID_SOTSetId', 'SpeechRecognitionType',
    'DISPID_SVSInputSentencePosition', 'SPVISEMES',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_PHRASE_START', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFT8kHz16BitStereo', 'SVEWordBoundary', 'ISpeechPhraseInfo',
    'DISPID_SpeechGrammarRules', 'SpeechVoiceSpeakFlags',
    'DISPID_SPIRetainedSizeBytes', 'ISpVoice', 'SPPHRASERULE',
    'DISPID_SOTCSetId', 'DISPID_SRRTLength', 'SVSFParseAutodetect',
    'SpeechMicTraining', 'DISPID_SpeechAudioFormat',
    'DISPID_SPEsCount', 'SDKLCurrentUser', 'SpeechPartOfSpeech',
    'DISPID_SpeechPhraseAlternates', 'SVP_14',
    'SGDSActiveUserDelimited', 'DISPID_SpeechDataKey', 'SINoise',
    'DISPID_SDKSetLongValue', 'SPWORD', 'SPEI_VISEME',
    'SpeechCategoryVoices', 'DISPID_SVAudioOutput', 'STCRemoteServer',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCEPropertyStringChange',
    'eLEXTYPE_PRIVATE8', 'IInternetSecurityMgrSite',
    'STCInprocServer', 'ISpeechRecoResultTimes',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SLWType',
    'DISPID_SVEStreamStart', 'SPVPRIORITY', 'ISpPhrase',
    'DISPID_SRSCurrentStreamPosition', 'SpInProcRecoContext',
    'SGRSTTTextBuffer', 'DISPID_SVESentenceBoundary', 'SBONone',
    'DISPID_SRCEBookmark', 'DISPID_SRGetPropertyString',
    'SAFT8kHz8BitStereo', 'DISPID_SPRuleFirstElement',
    'eLEXTYPE_PRIVATE5', 'DISPID_SRRTStreamTime', 'SSTTTextBuffer',
    'SPEI_SR_BOOKMARK', 'SPRST_ACTIVE', 'SSTTDictation',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechVoice',
    'DISPID_SOTDisplayUI', 'SPBOOKMARKOPTIONS', 'SP_VISEME_1',
    'DISPID_SRCState', 'SPRULESTATE', 'SpStream',
    'DISPID_SLWs_NewEnum', 'SDTReplacement', 'DISPID_SRRAlternates',
    'SP_VISEME_7', 'SREFalseRecognition', 'DISPID_SLPType',
    'DISPID_SADefaultFormat', 'SAFT11kHz16BitStereo', 'SPCT_COMMAND',
    'SPGS_ENABLED', 'SPSFunction', 'DISPID_SPERetainedSizeBytes',
    'SVSFUnusedFlags', 'SPAO_RETAIN_AUDIO', 'DISPID_SLWsItem',
    'ISpProperties', 'DISPID_SAVolume', 'SPFM_NUM_MODES',
    'DISPID_SGRSTType', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechPhraseBuilder', 'ISpDataKey',
    'SPINTERFERENCE_NOSIGNAL', 'SAFTADPCM_22kHzStereo',
    'SPPS_Unknown', 'DISPID_SASCurrentSeekPosition',
    'SPEI_TTS_BOOKMARK', 'SP_VISEME_8',
    'DISPID_SRSNumberOfActiveRules', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechMMSysAudio', 'SpeechRecoProfileProperties',
    'SPEI_PHONEME', 'DISPID_SGRSAddWordTransition',
    'ISpeechVoiceStatus', 'SPRECOGNIZERSTATUS',
    'SpeechStreamSeekPositionType', 'DISPID_SPIEnginePrivateData',
    'eLEXTYPE_PRIVATE11', 'DISPID_SRGCommit', 'SSFMOpenForRead',
    'DISPID_SVSVisemeId', 'DISPID_SPACommit', 'ISpeechLexiconWord',
    'DISPID_SOTCDefault', '_RemotableHandle', 'SRTSMLTimeout',
    'DISPID_SREmulateRecognition', 'SPEI_END_INPUT_STREAM',
    'DISPID_SVResume', 'eLEXTYPE_PRIVATE17', 'SPSHT_NotOverriden',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPPConfidence',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE13', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechPhraseAlternate', 'SAFT12kHz8BitMono',
    'DISPID_SRCESoundEnd', 'DISPID_SPRDisplayAttributes',
    'DISPID_SLAddPronunciation', 'SPWORDPRONUNCIATIONLIST', 'SASRun',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SABIMinNotification',
    'SGDisplay', 'SRSEIsSpeaking', 'SAFT24kHz16BitMono',
    'eLEXTYPE_RESERVED8', 'SVP_13', 'DISPID_SWFEFormatTag',
    'DISPID_SPIStartTime', 'DISPID_SRSetPropertyString',
    'SVSFIsNotXML', 'DISPID_SVSRunningState', 'SVP_11',
    'DISPID_SABIBufferSize', 'SVESentenceBoundary',
    'SAFT11kHz8BitMono', 'SPEI_UNDEFINED', 'DISPID_SPEs_NewEnum',
    'DISPID_SGRSAddSpecialTransition', 'SGDSActive',
    'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'ISpRecoGrammar', 'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_21',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechFileStream',
    'SAFT44kHz16BitMono', 'DISPID_SPRsCount',
    'SSSPTRelativeToCurrentPosition', 'SDTRule',
    'DISPID_SPISaveToMemory', 'DISPID_SVSLastBookmarkId',
    'SPPS_RESERVED2', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechPhraseInfo', 'SP_VISEME_19', 'SPRST_INACTIVE',
    'ISpEventSource', 'SPSERIALIZEDRESULT', 'ISpResourceManager',
    'SAFTExtendedAudioFormat', 'SpVoice', 'SVSFPurgeBeforeSpeak',
    'SpSharedRecognizer', 'LONG_PTR', 'SPWF_SRENGINE',
    'SAFT48kHz16BitMono', 'SpeechEmulationCompareFlags',
    'DISPID_SPRText', 'DISPID_SRCERecognition',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVGetProfiles', 'SRARoot',
    'SDTAll', 'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SGRAddResource',
    'eLEXTYPE_PRIVATE1', 'SpeechRecognizerState',
    'DISPID_SWFEBitsPerSample', 'SPEI_HYPOTHESIS', 'SPINTERFERENCE',
    'SECFIgnoreWidth', 'SAFT12kHz16BitMono', 'SRERecognition',
    'SPBO_TIME_UNITS', 'SpeechTokenContext', 'SDKLCurrentConfig',
    'SSFMOpenReadWrite', 'SPPS_RESERVED4', 'DISPID_SRAudioInput',
    'SP_VISEME_12', 'DISPID_SRCEEnginePrivate', 'DISPID_SRGetFormat',
    'ISpeechAudioFormat', 'SPSEMANTICFORMAT', 'SPPHRASEELEMENT',
    ...
    'SDA_One_Trailing_Space', 'SPEI_PROPERTY_NUM_CHANGE', 'SVP_15',
    'DISPID_SPEAudioSizeTime', 'ISpSerializeState',
    'DISPID_SPEEngineConfidence', 'SASPause', 'SPAS_CLOSED',
    'DISPID_SDKSetBinaryValue', 'eLEXTYPE_USER', 'SPPS_Noncontent',
    'eLEXTYPE_PRIVATE9', 'SVPAlert', 'SpeechVoicePriority',
    '_ISpeechVoiceEvents', 'SVPOver', 'SPPS_RESERVED1',
    'SPDATAKEYLOCATION', 'eLEXTYPE_PRIVATE7', 'SREPhraseStart',
    'DISPID_SpeechPhraseReplacements', 'SpeechStreamFileMode',
    'SWTAdded', 'DISPID_SRCERequestUI', 'SPEI_VOICE_CHANGE',
    'DISPID_SASNonBlockingIO', 'SDTProperty', 'tagSTATSTG',
    'SAFTADPCM_11kHzMono', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTNonStandardFormat', 'SpeechVoiceEvents',
    'SAFT22kHz8BitStereo', 'SPSVerb', 'SVP_21', 'SVF_None',
    'SPEI_RECOGNITION', 'DISPID_SRGCmdSetRuleState',
    'SpeechAudioVolume', 'ISpAudio', 'SPCS_DISABLED',
    'SECFIgnoreKanaType', 'SPDKL_CurrentConfig',
    'SPTEXTSELECTIONINFO', 'DISPID_SRRPhraseInfo',
    'eLEXTYPE_RESERVED4', 'SVP_17', 'SAFTCCITT_uLaw_22kHzMono',
    'ISpeechPhraseElement', 'ISpeechPhoneConverter',
    'DISPID_SpeechPhraseElements', 'SECFEmulateResult',
    'DISPID_SRRecognizer', 'DISPID_SVSpeak', 'SPADAPTATIONRELEVANCE',
    'SPSLMA', 'DISPID_SRCEAudioLevel', 'SRCS_Enabled',
    ...
    'DISPID_SRGetRecognizers', 'SpeechFormatType', 'SPLEXICONTYPE',
    'DISPID_SRGState', 'SPEI_SOUND_END', 'SpeechDataKeyLocation',
    'SRAInterpreter', 'SPPS_Modifier', 'DISPID_SpeechPhraseProperty',
    'SITooQuiet', 'DISPID_SGRSTransitions',
    'DISPID_SOTGetDescription', 'SPFM_OPEN_READONLY', 'SPPS_Verb',
    'SPEI_MIN_SR', 'SpMMAudioIn', 'SpeechCategoryAppLexicons',
    'SREPrivate', 'SPEI_SR_AUDIO_LEVEL', 'SVP_4',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_PRIVATE14', 'DISPIDSPRG',
    'DISPID_SMSADeviceId', 'DISPID_SVVoice', 'DISPID_SRGRules',
    'SAFT44kHz8BitMono', 'STSF_AppData',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SAEventHandle',
    'SECFIgnoreCase', 'ISpeechRecognizerStatus', 'SpeechRunState',
    'SpeechInterference', 'DISPID_SRCResume', 'SVP_1', 'SPWT_LEXICAL',
    'SPSInterjection', 'SVEPhoneme', 'DISPID_SpeechXMLRecoResult',
    'SVP_8', 'SDTPronunciation', 'DISPID_SLGenerationId',
    'SAFTCCITT_uLaw_44kHzMono', 'SVP_3', 'SPRECORESULTTIMES',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpResourceManager',
    'SpeechRecoEvents', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPIGetText', 'SPBO_PAUSE', 'SPWT_DISPLAY',
    'SAFT24kHz8BitStereo', 'SPWORDLIST',
    'DISPID_SpeechRecognizerStatus', 'SDA_Consume_Leading_Spaces',
    'ISpeechAudioBufferInfo', 'SVP_9', 'ISpeechAudio',
    'eLEXTYPE_PRIVATE3', 'SAFT12kHz16BitStereo', 'ISpeechDataKey',
    'SAFT44kHz16BitStereo', 'DISPID_SpeechObjectToken',
    'DISPID_SRCEEndStream', 'SDTAlternates', 'SPXRO_SML',
    'SP_VISEME_10', 'SPCT_SUB_DICTATION', 'DISPID_SPIAudioSizeBytes',
    'STSF_CommonAppData', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRGDictationLoad', '__MIDL_IWinTypes_0009', 'SREBookmark',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SPPId', 'DISPID_SVPause',
    'DISPID_SRCBookmark', 'DISPID_SGRId', 'SGSDisabled',
    'DISPID_SpeechPhraseReplacement', 'eLEXTYPE_RESERVED9',
    ...
    'DISPID_SPELexicalForm', 'DISPID_SPIProperties',
    'SPEI_FALSE_RECOGNITION', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SWPKnownWordPronounceable', 'ISpGrammarBuilder', 'SP_VISEME_15',
    'SPSHT_EMAIL', 'DISPID_SBSWrite', 'DISPID_SRGSetTextSelection',
    'SRESoundStart', 'SPVPRI_OVER', 'SpeechSpecialTransitionType',
    'SPEVENTENUM', 'DISPID_SRCCmdMaxAlternates',
    'ISpPhoneticAlphabetConverter', 'ISpeechLexiconPronunciation',
    'ISpeechMemoryStream', 'DISPID_SRRTTickCount', 'SPEI_RESERVED2',
    'SAFT48kHz8BitMono', 'DISPID_SRSetPropertyNumber',
    'SAFTADPCM_22kHzMono', 'SSTTWildcard', 'eWORDTYPE_DELETED',
    'SAFTCCITT_ALaw_8kHzMono', 'SSFMCreate', 'SpFileStream',
    'SRAONone', 'DISPID_SVSyncronousSpeakTimeout', 'STCLocalServer',
    'SREInterference', 'ISpeechRecoContext',
    'DISPID_SpeechVoiceEvent', 'SpeechGrammarState',
    'DISPID_SDKEnumValues', 'DISPID_SVEVoiceChange',
    'SpeechAllElements', 'ISpeechFileStream', 'SpShortcut',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVIsUISupported',
    'SPSNotOverriden', 'SPPARTOFSPEECH', 'SpObjectToken',
    'SAFTDefault', 'SpeechAudioProperties', 'DISPID_SMSSetData',
    'ISpNotifySource', 'SVSFPersistXML', 'SPSHT_Unknown',
    'ISpeechBaseStream', 'SpAudioFormat', 'DISPID_SPPName',
    'SPRS_INACTIVE', 'DISPID_SRRDiscardResultInfo', 'SECFDefault',
    'SpeechAudioFormatType', 'DISPID_SASFreeBufferSpace',
    'SVSFParseMask', 'DISPID_SRCPause', 'STSF_LocalAppData',
    'DISPID_SVSPhonemeId', 'DISPID_SVSInputSentenceLength',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPIRule', 'DISPID_SPCPhoneToId',
    'SPAR_Unknown', 'SpeechCategoryAudioOut',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCEPhraseStart',
    'SPSUnknown', 'SPCT_SUB_COMMAND', 'DISPID_SPPNumberOfElements',
    'SPAO_NONE', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCCreateGrammar', 'SpeechUserTraining', 'SBOPause',
    'SPCATEGORYTYPE', 'SPINTERFERENCE_TOOQUIET',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpRecoCategory',
    'DISPID_SRCRecognizer', 'SpeechTokenKeyAttributes',
    'SPINTERFERENCE_NONE', 'DISPID_SLWsCount', 'SGSEnabled',
    'SpeechRecoContextState', 'SAFT48kHz8BitStereo',
    'DISPID_SRRSpeakAudio', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPXMLRESULTOPTIONS', 'SpeechCategoryAudioIn',
    'DISPID_SpeechObjectTokens', 'eLEXTYPE_PRIVATE6',
    'DISPID_SOTsCount', 'DISPID_SPAsCount', 'SAFTGSM610_8kHzMono',
    'SPPROPERTYINFO', 'SpeechAddRemoveWord',
    'DISPID_SVEventInterests', 'ISpeechWaveFormatEx',
    'SAFT8kHz16BitMono', 'DISPID_SDKGetlongValue',
    'DISPID_SDKGetStringValue', 'DISPID_SPEsItem', 'DISPID_SVSkip',
    'DISPID_SPRuleEngineConfidence', 'ISpRecoContext2',
    'ISpRecoGrammar2', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVSFNLPMask',
    'SPEI_WORD_BOUNDARY', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SVGetVoices',
    'DISPID_SpeechGrammarRule', 'DISPID_SWFEChannels',
    'SPEI_END_SR_STREAM', 'SAFTCCITT_ALaw_44kHzMono', 'ISpLexicon',
    'SVP_18', 'SPWORDPRONUNCIATION', 'SAFTNoAssignedFormat',
    'SPLO_STATIC', 'DISPID_SGRSTs_NewEnum', 'DISPID_SOTIsUISupported',
    'SP_VISEME_4', 'SVEPrivate', 'ISpeechRecoResult2',
    'DISPID_SGRSTNextState', 'eLEXTYPE_RESERVED10',
    'DISPID_SRCSetAdaptationData', 'DISPID_SVAudioOutputStream',
    'DISPID_SLWLangId', 'SRCS_Disabled', 'SRAExport',
    'DISPID_SPIGrammarId', 'SPEI_RESERVED6', 'SPFM_OPEN_READWRITE',
    'SPEI_MIN_TTS', 'eLEXTYPE_RESERVED6', 'SP_VISEME_18',
    'SREHypothesis', 'ISpPhoneConverter', 'SP_VISEME_14',
    'SpeechGrammarTagWildcard', 'SGRSTTRule', 'DISPID_SOTs_NewEnum',
    'SVEAllEvents', 'DISPID_SASetState', 'ISpeechLexicon',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SDKCreateKey',
    'DISPID_SLPLangId', 'SRERecoOtherContext',
    'SpeechEngineConfidence', 'SpeechVisemeType', 'SLTUser',
    'ISpeechAudioStatus', 'DISPID_SpeechBaseStream',
    'DISPID_SPRNumberOfElements', 'ISpEventSink', 'SVEAudioLevel',
    'DISPID_SWFEAvgBytesPerSec', 'SPEI_MAX_TTS', 'SDTAudio',
    'DISPID_SpeechRecoResult', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPRuleConfidence', 'SVSFParseSsml', 'IEnumString',
    'SREAdaptation', 'SPAUDIOSTATUS', 'DISPID_SRCRequestedUIType',
    'SAFT32kHz16BitStereo', 'SAFTGSM610_22kHzMono', 'SRTAutopause',
    'DISPID_SGRSTText', 'DISPID_SGRSTPropertyId',
    'DISPID_SPRFirstElement', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SVEBookmark', 'DISPID_SPEDisplayText', 'SPEVENT',
    'DISPID_SRCEPropertyNumberChange', 'ISpeechMMSysAudio',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRsCommit',
    'SpMemoryStream', 'eLEXTYPE_PRIVATE10',
    'SpeechRetainedAudioOptions', 'DISPID_SRRAudio', 'SLODynamic',
    'DISPID_SpeechRecognizer', 'SINoSignal',
    'DISPID_SGRsCommitAndSave', 'ISpeechPhraseRules', 'SP_VISEME_2',
    'DISPID_SPCLangId', 'DISPID_SPRsItem', 'SpeechTokenKeyUI',
    'SPPHRASEPROPERTY', 'SpStreamFormatConverter', 'SPPS_Function',
    'DISPID_SWFEBlockAlign', 'SpeechVisemeFeature',
    'DISPID_SVWaitUntilDone', 'SpeechRegistryUserRoot',
    'SpWaveFormatEx', 'DISPID_SPARecoResult', 'DISPID_SPILanguageId',
    'SP_VISEME_9', 'SAFT8kHz8BitMono', 'SECNormalConfidence',
    'DISPID_SVPriority', 'DISPID_SpeechLexiconWord',
    'SPGRAMMARWORDTYPE', 'SpeechWordPronounceable',
    'DISPID_SPERequiredConfidence', 'SVP_6', 'SPRULE',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'STCAll', 'DISPID_SPRuleId',
    'DISPIDSPTSI_SelectionOffset', 'SVP_5', 'SpeechAudioState',
    ...
    'SAFT48kHz16BitStereo', 'SPEI_MAX_SR', 'SVSFDefault',
    'DISPID_SpeechAudioStatus', 'ISpNotifySink',
    'SAFT16kHz8BitStereo', 'SPSSuppressWord', 'DISPID_SPRulesCount',
    'DISPID_SGRsAdd', 'SPEI_RESERVED3', 'DISPID_SOTDataKey',
    'DISPID_SRGDictationUnload', 'DISPID_SpeechRecoContext',
    'UINT_PTR', 'SP_VISEME_6', 'SPCT_DICTATION',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCEStartStream',
    'SpeechAudioFormatGUIDWave', 'DISPID_SVDisplayUI', 'SPPS_LMA',
    'SPSHORTCUTTYPE', 'SpeechPropertyAdaptationOn', 'SPGS_EXCLUSIVE',
    'DISPID_SGRInitialState', 'DISPID_SVEAudioLevel',
    'DISPID_SABufferNotifySize', 'ISpeechPhraseAlternate',
    'SAFTADPCM_44kHzStereo', 'SLOStatic', 'DISPID_SPIAudioSizeTime',
    'SRSActive', 'SECFNoSpecialChars', 'SP_VISEME_17',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTCreateInstance',
    'SPAR_Low', 'DISPID_SPPParent', 'DISPID_SVSLastBookmark',
    ...
    'DISPID_SRRSetTextFeedback', 'ISpeechPhraseRule', 'SPWORDTYPE',
    'SRTEmulated', 'SINone', 'SVF_Emphasis', 'SPWORDPRONOUNCEABLE',
    'SPSHT_OTHER', 'DISPID_SABufferInfo', 'ISpMMSysAudio', 'SAFTText',
    'DISPID_SBSRead', 'DISPID_SRGReset',
    'DISPID_SOTMatchesAttributes', 'DISPID_SRCRetainedAudio',
    'ISpRecognizer2', 'SRERequestUI', 'SpeechTokenKeyFiles',
    'SRSInactive', 'DISPID_SRRRecoContext',
    'DISPID_SpeechCustomStream', 'SVF_Stressed', 'SGLexical',
    'SPEI_SR_RETAINEDAUDIO', 'SRSActiveAlways',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SAFSetWaveFormatEx',
    'SPAS_RUN', 'SDA_Two_Trailing_Spaces', 'SPRST_ACTIVE_ALWAYS',
    'SVEViseme', 'SPINTERFERENCE_TOOFAST', 'DISPID_SVRate',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SLRemovePronunciation',
    'SPAUDIOOPTIONS', 'DISPID_SPIGetDisplayAttributes',
    'SAFTCCITT_uLaw_11kHzMono', 'eLEXTYPE_PRIVATE16',
    'ISpeechPhraseReplacements', 'SpInprocRecognizer',
    'SAFT16kHz16BitMono', 'SPSModifier', 'SFTInput',
    'SGRSTTDictation', 'SECHighConfidence', 'SpLexicon',
    'DISPID_SRGId', 'SPPS_Interjection', 'SAFTGSM610_11kHzMono',
    ...
    'ISpeechCustomStream', 'DISPID_SOTCEnumerateTokens',
    'SpeechRuleAttributes', 'eWORDTYPE_ADDED',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPRuleChildren',
    'SPEVENTSOURCEINFO', 'ISpeechRecoResult', 'DISPID_SCSBaseStream',
    'DISPID_SDKEnumKeys', 'SP_VISEME_16', 'Speech_StreamPos_RealTime',
    'SVEVoiceChange', 'DISPID_SPPValue', 'SpNullPhoneConverter',
    ...
    'SPXRO_Alternates_SML', 'DISPID_SGRName',
    'DISPID_SpeechPhoneConverter', 'SPWT_PRONUNCIATION',
    'DISPID_SLPs_NewEnum', 'SITooSlow', 'SPRS_ACTIVE_USER_DELIMITED',
    'SRAImport', 'DISPID_SRIsShared', 'DISPID_SRSClsidEngine',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechLexiconProns',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SVStatus', 'ISpShortcut',
    'IStream', 'eLEXTYPE_PRIVATE12', 'SVPNormal', 'SPSMF_UPS',
    'DISPID_SMSGetData', 'SRAORetainAudio', 'DISPID_SPRuleParent',
    'ISpObjectToken', 'ISpeechRecoGrammar', 'SPCS_ENABLED',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVP_7', 'SPAUDIOSTATE',
    'DISPID_SPRs_NewEnum', 'DISPID_SRProfile', 'SpeechLoadOption',
    'DISPID_SOTCId', 'STCInprocHandler', 'SpeechCategoryRecognizers',
    'SPSTREAMFORMATTYPE', 'DISPID_SGRSTPropertyName',
    'DISPID_SAFType', 'SVEEndInputStream',
    'DISPID_SASCurrentDevicePosition', 'ISpeechGrammarRule',
    'DISPID_SpeechPhraseElement', 'SDTDisplayText',
    'DISPID_SPIEngineId', 'ISpeechGrammarRuleStateTransition',
    'SP_VISEME_0', 'SpeechTokenShellFolder',
    'SpeechGrammarRuleStateTransitionType', 'SpeechGrammarWordType',
    'DISPID_SPPsItem', 'SVP_20',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechPropertyResourceUsage', 'SVSFlagsAsync', 'SPVPRI_ALERT',
    'DISPID_SpeechPhraseProperties', 'SPGRAMMARSTATE',
    'ISpeechPhraseProperty', 'ISpXMLRecoResult',
    'DISPID_SMSAMMHandle', 'SGRSTTWord', 'DISPID_SPAPhraseInfo',
    'DISPID_SMSALineId', 'SPEI_START_INPUT_STREAM',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE20',
    'SAFTADPCM_11kHzStereo', 'tagSPPROPERTYINFO',
    'DISPID_SRCEventInterests', 'DISPID_SRGRecoContext',
    'SPLO_DYNAMIC', 'SVSFIsFilename', 'SpCompressedLexicon',
    'DISPID_SBSSeek', 'DISPID_SGRSTsItem', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPIReplacements', 'SREAllEvents',
    'DISPID_SOTRemoveStorageFileName', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVP_2', 'ISpObjectTokenCategory', 'SpeechLexiconType',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechPhraseRule',
    'SGRSTTEpsilon', 'ISpeechObjectToken', 'SpeechTokenValueCLSID',
    'DISPID_SRRTimes', 'SFTSREngine', 'DISPID_SRCreateRecoContext',
    'DISPID_SRSSupportedLanguages', 'SpPhoneticAlphabetConverter',
    'DISPID_SPIElements', 'SPSHORTCUTPAIR', 'ISpStreamFormat',
    'Speech_Max_Word_Length', 'DISPID_SLGetPronunciations',
    'SPRST_NUM_STATES', 'DISPID_SRCERecognitionForOtherContext',
    'SPRECOSTATE', 'DISPID_SPAs_NewEnum', 'SDA_No_Trailing_Space',
    'SpeechDictationTopicSpelling', 'DISPID_SGRsDynamic',
    'DISPID_SRCESoundStart', 'SAFT44kHz8BitStereo',
    'ISpeechGrammarRuleState', 'SRADefaultToActive',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SLGetGenerationChange',
    'SVP_12', 'SpeechDisplayAttributes', 'SPEI_START_SR_STREAM',
    'eLEXTYPE_PRIVATE4', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRCVoice', 'SVP_0', 'SPDKL_DefaultLocation',
    'SGLexicalNoSpecialChars', 'SREPropertyStringChange',
    'SPBINARYGRAMMAR', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SREStreamEnd', 'SRTReSent', 'SP_VISEME_11', 'ISpStream',
    'DISPID_SVSpeakStream', 'SRESoundEnd', 'SpMMAudioEnum',
    'SPRECOCONTEXTSTATUS', 'SpeechGrammarTagDictation',
    'DISPID_SPAsItem', 'DISPID_SPAStartElementInResult',
    'SpeechTokenIdUserLexicon', 'SpeechCategoryPhoneConverters',
    'SPDKL_CurrentUser', 'SSFMCreateForWrite', 'ISpRecoResult',
    'SRSInactiveWithPurge', 'DISPID_SRAudioInputStream', 'SPAS_PAUSE',
    'DISPID_SRCCreateResultFromMemory',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpCustomStream',
    'DISPID_SGRsItem', 'DISPID_SVSInputWordPosition', 'SVP_16',
    'SPAR_Medium', 'DISPID_SGRs_NewEnum', 'SREAudioLevel',
    'DISPID_SVEPhoneme', 'SGSExclusive', 'SpeechCategoryRecoProfiles',
    'DISPID_SPEPronunciation', 'ISequentialStream',
    'ISpStreamFormatConverter', 'SPSMF_SAPI_PROPERTIES',
    'SPGS_DISABLED', 'DISPID_SVEStreamEnd', 'SPCONTEXTSTATE',
    'SP_VISEME_20', 'DISPID_SGRClear', 'DISPID_SGRAddState',
    'DISPID_SpeechVoiceStatus', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecoResult2', 'SPINTERFERENCE_NOISE',
    'ISpRecognizer3', 'DISPID_SAStatus', 'eLEXTYPE_RESERVED7',
    'SAFT22kHz16BitMono', 'SAFT22kHz16BitStereo', 'SGDSInactive',
    'DISPID_SOTCategory', 'SpeechDiscardType', 'DISPID_SLWWord',
    ...
    'SAFTADPCM_8kHzStereo', 'DISPID_SPPsCount', 'SPPHRASE',
    'DISPID_SRGetPropertyNumber', 'DISPID_SVEViseme', 'SVSFVoiceMask',
    'DISPID_SVEWord', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SRADynamic', 'ISpeechLexiconPronunciations', 'SASStop',
    'DISPID_SDKOpenKey', 'DISPID_SOTId', 'DISPID_SPEActualConfidence',
    'DISPID_SPPEngineConfidence', 'SPEI_SR_PRIVATE',
    'ISpeechGrammarRules', 'DISPID_SDKDeleteValue',
    'DISPID_SLPPhoneIds', 'DISPID_SRStatus', 'SLTApp',
    'DISPID_SpeechGrammarRuleState', 'ISpeechObjectTokens',
    'DISPIDSPTSI', 'SPFM_CREATE', 'ISpPhraseAlt',
    'SWPUnknownWordPronounceable', 'SRTStandard', 'SpeechRuleState',
    'SPWF_INPUT', 'SPAR_High', 'SPPHRASEREPLACEMENT',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPSHORTCUTPAIRLIST', 'eLEXTYPE_PRIVATE2', 'DISPID_SLPsItem',
    'SAFT24kHz8BitMono', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SDKSetStringValue', 'SPAS_STOP',
    'DISPID_SRRGetXMLErrorInfo', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRIsUISupported', 'SITooLoud',
    'DISPID_SRGIsPronounceable', 'SECLowConfidence',
    'SGPronounciation', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVVolume', 'DISPID_SDKDeleteKey',
    'DISPID_SVSCurrentStreamNumber', 'SPCT_SLEEP',
    'SpSharedRecoContext', 'SpeechWordType',
    'DISPID_SLWPronunciations', 'SDTLexicalForm', 'SP_VISEME_3',
    'SPBO_NONE', 'SpPhraseInfoBuilder', 'DISPID_SLPPartOfSpeech',
    'SAFT24kHz16BitStereo', 'DISPID_SRGCmdLoadFromMemory',
    'ISpRecoContext', 'DISPID_SRCAudioInInterferenceStatus',
    'SPFILEMODE', 'SPPS_SuppressWord', 'SSSPTRelativeToEnd',
    'SAFTCCITT_ALaw_22kHzMono', 'ISpeechPhraseReplacement',
    'DISPID_SOTsItem', 'ISpNotifyTranslator',
    'SpTextSelectionInformation', 'DISPID_SAFGuid', 'SASClosed',
    'DISPID_SPRulesItem', 'SPEI_ADAPTATION', 'eLEXTYPE_PRIVATE15',
    'eLEXTYPE_PRIVATE18', 'SVEBookmark', 'SVSFParseSapi',
    'DISPID_SRGCmdSetRuleIdState', 'SPAUDIOBUFFERINFO',
    'SAFT32kHz8BitStereo', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRRSaveToMemory', 'SPVPRI_NORMAL', 'SPBO_AHEAD',
    ...
    'SPEI_REQUEST_UI', 'ISpeechXMLRecoResult',
    'DISPID_SRSAudioStatus', 'DISPID_SGRSTRule', 'SVSFIsXML',
    'DISPID_SFSOpen', 'DISPID_SASState', 'SAFT16kHz16BitStereo',
    ...
    'SITooFast', 'DISPID_SVGetAudioOutputs', 'DISPID_SLGetWords',
    'SPWAVEFORMATTYPE', 'SPPS_NotOverriden', 'STSF_FlagCreate',
    'SVEStartInputStream', 'SWTDeleted', 'DISPID_SRRAudioFormat',
    '_SPAUDIOSTATE', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'Speech_Max_Pron_Length',
    'DISPID_SOTCGetDataKey', 'SPPS_Noun', 'SPPS_RESERVED3',
    'eLEXTYPE_APP', 'DISPID_SRState', 'DISPID_SGRSTsCount',
    'SAFTCCITT_ALaw_44kHzStereo', 'SPINTERFERENCE_TOOSLOW', 'SVP_10',
    'SRTExtendableParse', 'DISPID_SVSLastResult',
    'SpeechAudioFormatGUIDText', 'DISPID_SPERetainedStreamOffset',
    'SVP_19', 'DISPID_SWFEExtraData', 'SPEI_SOUND_START',
    'DISPID_SGRsFindRule', 'SPRS_ACTIVE', 'ISpeechPhraseElements',
    'IEnumSpObjectTokens', 'SpeechEngineProperties', 'SRSEDone',
    'SSSPTRelativeToStart', 'SpeechBookmarkOptions',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SpeechLexicon'
]

_check_version('1.1.14', 1610724162.674675)
